...
TOC_TOGGLE_SCRIPT = (
    ...
    "function sync(){var c=r.classList.contains('nav-collapsed');var l=c?'과목 목차 펼치기':'과목 목차 접기';"
...
def sidebar_html(subject_lectures: list[Lecture], current: Lecture, subject_prefix: str) -> str:
    ...
    chunks = [
        ...
        'aria-label="과목 목차 접기" title="과목 목차 접기">'
        '<span class="toc-hide" aria-hidden="true">◀ 접기</span>'
        '<span class="toc-show" aria-hidden="true">☰</span></button></div>'
