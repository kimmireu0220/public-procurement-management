...
class LecturePagesTest(unittest.TestCase):
    def test_sources_have_expected_chapter_structure(self) -> None:
        ...
        self.assertEqual(
            {part: len([item for item in subject4 if item.part == part]) for part in range(1, 9)},
    ...
    def test_build_creates_navigation_and_future_subject_cards(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(meta["total_chapters"], 104)
            ...
            latest_prior_part6_ch2_4 = destination / "4" / "part06" / "chapter02" / "index.html"
            latest_prior_part6_ch3_4 = destination / "4" / "part06" / "chapter03" / "index.html"
            latest_prior_part6_ch4_4 = destination / "4" / "part06" / "chapter04" / "index.html"
            latest_prior_part7_ch1_4 = destination / "4" / "part07" / "chapter01" / "index.html"
            latest_prior_part7_ch2_4 = destination / "4" / "part07" / "chapter02" / "index.html"
            latest_prior_part7_ch3_4 = destination / "4" / "part07" / "chapter03" / "index.html"
            latest_prior_part8_ch1_4 = destination / "4" / "part08" / "chapter01" / "index.html"
            current4 = destination / "4" / "part08" / "chapter02" / "index.html"
            ...
            self.assertTrue(latest_prior_part6_ch2_4.is_file())
            self.assertTrue(latest_prior_part6_ch3_4.is_file())
            self.assertTrue(latest_prior_part6_ch4_4.is_file())
            self.assertTrue(latest_prior_part7_ch1_4.is_file())
            self.assertTrue(latest_prior_part7_ch2_4.is_file())
            self.assertTrue(latest_prior_part7_ch3_4.is_file())
            self.assertTrue(latest_prior_part8_ch1_4.is_file())
