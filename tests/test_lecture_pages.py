...
class LecturePagesTest(unittest.TestCase):
    def test_sources_have_expected_chapter_structure(self) -> None:
        ...
        self.assertEqual(len(chapters), 103)
        ...
        self.assertEqual(
            ...
            {1: 3, 2: 3, 3: 3, 4: 4, 5: 3, 6: 4, 7: 3, 8: 1},
        )
    ...
    def test_build_creates_navigation_and_future_subject_cards(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(meta["total_chapters"], 103)
            ...
            current4 = destination / "4" / "part08" / "chapter01" / "index.html"
